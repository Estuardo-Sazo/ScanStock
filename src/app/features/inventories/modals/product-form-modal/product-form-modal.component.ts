...
import { ModalController, IonContent, IonFooter, IonIcon, IonButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, IonContent, IonFooter, IonIcon, IonButton],
